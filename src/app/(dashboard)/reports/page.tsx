...
import { todayISO, firstOfMonthISO } from '@/lib/utils/date-filters';
...
export default function ReportsPage() {
  ...
  if (!loading && rows.length === 0 && filters.preset === 'this_month' && !filters.patientId && filters.objectiveFilter === 'ALL') {
    return (
      <div className="mx-auto flex max-w-lg flex-col items-center justify-center py-24 text-center">
        ...
        <p className="mt-2 text-pretty text-sm text-ink-secondary">Las fórmulas desarrolladas que guardes aparecerán aquí como historial de consultas.</p>
